...
<% 
           ...
           try{
                ...
                PreparedStatement pstmt = con.prepareStatement("select * from doc where email=?");
                ...
                <table>
                    ...
                    <tr>             
                        ...
                        <td><%=rs.getString("qualification")%></td>
                         <td><input type="text" name="t3" value="<%=rs.getString("qualification")%>"/></td>
                    </tr>
                    <tr>        
                        <td>Address</td>
              ...
              <td><input type="text" name="t6" value="<%=rs.getString("gender")%>"/></td>
                    ...
                    <tr>               
                        ...
                        <td><%=rs.getString("sq")%></td>
                <td><input type="text" name="t7" value="<%=rs.getString("sq")%>"/></td>

                    </tr>
                    <tr>
                        <td>Security Answer : <%=rs.getString("sa")%></td>
                        <td><%=rs.getString("sa")%></td>
                   <td><input type="text" name="t8" value="<%=rs.getString("sa")%>"/></td>
